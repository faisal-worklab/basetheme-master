...
class WP_Theme_Setup {
	...
	public function setup_function() {
		...
		load_theme_textdomain( 'divsflow_td' );
		...
		register_nav_menus(
			array(
				'header-nav'       => __( 'Header Nav', 'divsflow_td' ),
				'footer-nav-one'   => __( 'Footer Nav One', 'divsflow_td' ),
				'footer-nav-two'   => __( 'Footer Nav Two', 'divsflow_td' ),
				'footer-nav-three' => __( 'Footer Nav Three', 'divsflow_td' ),
				'legal-nav'        => __( 'Legal Nav', 'divsflow_td' ),
			)
		);
