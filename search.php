...
<section id="hero-section" class="hero-section hero-section-default">
	...
	<div class="hero-single search-hero">
		<div class="wrapper">
			<h1><?php echo esc_html_e( 'Search Results', 'divsflow_td' ); ?></h1>
			<p>
			<?php
				printf(
					/* translators: %s: search term. */
					esc_html__( 'Results for "%s"', 'divsflow_td' ),
...
<section id="page-section" class="page-section">
	<div class="wrapper">
		<div class="post-archive <?php DivsFlow::have_post_class( 'three-columns' ); ?>">
			<!-- Content Start -->
			<?php
			if ( have_posts() ) {
				while ( have_posts() ) {
			...
			<?php
			if ( have_posts() ) {
				if ( class_exists( 'DivsFlow' ) && $wp_query->max_num_pages > 1 ) {
					?>
						<div class="center-align">
							<?php DivsFlow::pagination( $wp_query->max_num_pages ); ?>
						</div>
					<?php
				}
			}
