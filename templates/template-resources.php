...
$dfb_var_pagetitle          = $dfb_fields['dfb_var_pagetitle'] ?? get_the_title();
$dfb_var_trcho_feature_post = $dfb_fields['dfb_var_trcho_feature_post'] ?? null;
...
<section id="hero-section" class="hero-section hero-section-default">
	<div class="blog-hero">
		<div class="wrapper">
			...
			<?php
			if ( $dfb_var_trcho_feature_post ) {
				?>
				<?php
				foreach ( $dfb_var_trcho_feature_post as $dfb_var_post_id ) {
